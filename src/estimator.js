const covid19ImpactEstimator = (data) => {
  ...
  const impactCasesForICU = Math.ceil(infectionsByRequestedTimeImpact * 0.05);
  const impactCasesForVentilators = Math.ceil(0.02 * infectionsByRequestedTimeImpact);
  ...
  const severeCasesForICU = Math.ceil(infectionsByRequestedTimeSevere * 0.05);
  const severeCasesForVentilators = Math.ceil(infectionsByRequestedTimeSevere * 0.02);
